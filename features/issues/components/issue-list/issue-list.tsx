...
export function IssueList() {
  ...
  function filterChangeHandler(filter: {
    level?: string;
    status?: string;
    project?: string;
  }) {
    router.push({
      pathname: router.pathname,
      query: {
        page: 1, // reset the page number when the filter options are changed
  ...
  return (
    <>
      <IssueFilterBar data={searchFilter} onChange={filterChangeHandler} />
